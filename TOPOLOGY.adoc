...
Central monorepo unifying 20+ hyperpolymath Julia libraries into
cohesive post-disciplinary research and verified computing ecosystem.
Spans formal logic, cryptography, historical dynamics, labor organizing,
