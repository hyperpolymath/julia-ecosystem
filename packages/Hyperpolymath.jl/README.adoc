...
* link:packages/ProvenCrypto.jl[ProvenCrypto.jl], link:packages/InvestigativeJournalism.jl[InvestigativeJournalism.jl]
...
* link:packages/TradeUnionism.jl[TradeUnionism.jl], link:packages/PRComms.jl[PRComms.jl], link:packages/Exnovation.jl[Exnovation.jl], link:packages/BowtieRisk.jl[BowtieRisk.jl]
* link:packages/JuliaForChildren.jl[JuliaForChildren.jl], link:packages/KnotTheory.jl[KnotTheory.jl], link:packages/Skein.jl[Skein.jl], link:packages/HackenbushGames.jl[HackenbushGames.jl], link:packages/Cladistics.jl[Cladistics.jl]
