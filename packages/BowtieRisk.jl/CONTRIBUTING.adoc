...
git clone https://github.com/hyperpolymath/BowtieRisk.jl.git cd
BowtieRisk.jl
...
toolbox create BowtieRisk.jl-dev toolbox enter BowtieRisk.jl-dev #
...
BowtieRisk.jl/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
