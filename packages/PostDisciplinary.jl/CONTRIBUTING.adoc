...
toolbox create \{\{REPO}}-dev toolbox enter \{\{REPO}}-dev # Install
...
\{\{REPO}}/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
...
LICENSE ├── MAINTAINERS.md ├── README.adoc ├── SECURITY.md ├── flake.nix
# Nix flake — fallback (Perimeter 1) ├── guix.scm # Guix package —
primary (Perimeter 1) └── Justfile # Task runner (Perimeter 1)
