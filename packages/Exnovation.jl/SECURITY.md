...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/Exnovation.jl/security/advisories/new)
...
| **PGP Key** | [Download Public Key]((not yet configured)) |
| **Fingerprint** | `(not yet configured)` |

```bash
# Import our PGP key
curl -sSL (not yet configured) | gpg --import
...
- This repository (`hyperpolymath/Exnovation.jl`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/Exnovation.jl/security/advisories)
...
When using Exnovation.jl, we recommend:
...
- [Our PGP Public Key]((not yet configured))
- [Security Advisories](https://github.com/hyperpolymath/Exnovation.jl/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/Exnovation.jl/security/advisories/new) or jonathan.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/Exnovation.jl/discussions) |
...
*Thank you for helping keep Exnovation.jl and its users safe.* 🛡️
