...
Replace all {{PLACEHOLDER}} values with your information:
  ...
  julia-ecosystem             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/julia-ecosystem/security/advisories/new)
...
- This repository (`hyperpolymath/julia-ecosystem`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/julia-ecosystem/security/advisories)
...
- [Security Advisories](https://github.com/hyperpolymath/julia-ecosystem/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/julia-ecosystem/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/julia-ecosystem/discussions) |
