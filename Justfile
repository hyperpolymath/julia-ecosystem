...
doctor:
    @echo "Running diagnostics for julia-ecosystem..."
...
help-me:
    @echo "=== julia-ecosystem Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/julia-ecosystem/issues/new"
    @echo ""
