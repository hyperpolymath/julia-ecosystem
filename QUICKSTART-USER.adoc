...
// Replace julia-ecosystem, Julia Ecosystem — See README.adoc for details., just run, Julia Ecosystem started successfully. with actuals
= julia-ecosystem — Quick Start for Users
:toc:
:toclevels: 2

== What is julia-ecosystem?

Julia Ecosystem — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./julia-ecosystem-portable
----
...
[source]
----
Julia Ecosystem started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/julia-ecosystem/wiki
