...
[arabic]
. Navigate to
https://github.com/hyperpolymath/Exnovation.jl/security/advisories/new[Report
a Vulnerability]
...
|*PGP Key* |link:(not%20yet%20configured)[Download Public Key]
...
https://github.com/hyperpolymath/Exnovation.jl/security/advisories[Security
Advisories]
...
* link:(not%20yet%20configured)[Our PGP Public Key]
* https://github.com/hyperpolymath/Exnovation.jl/security/advisories[Security
Advisories]
...
|*Security issues*
|https://github.com/hyperpolymath/Exnovation.jl/security/advisories/new[Report
via GitHub] or jonathan.jewell@open.ac.uk

|*General questions*
|https://github.com/hyperpolymath/Exnovation.jl/discussions[GitHub
Discussions]
...
_Thank you for helping keep Exnovation.jl and its users safe._ 🛡️
