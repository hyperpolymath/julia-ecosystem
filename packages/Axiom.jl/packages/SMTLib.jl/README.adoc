...
____
*Standalone Package*: This package is designed to be published
independently. Currently bundled with
https://github.com/hyperpolymath/axiom.jl[Axiom.jl] at
`+packages/SMTLib.jl+`. To publish separately, copy this directory to a
new repository.
____
...
Extracted from https://github.com/hyperpolymath/axiom.jl[Axiom.jl], a
provably correct ML framework.
