...
Topology]]
link:TOPOLOGY.md[image:https://img.shields.io/badge/Completion-72%25-yellow[Completion
Status]]
...
`+p(top_event) * Π(1 - barrier_effectiveness)+`
...
specs. These are design aids for arranging bowtie diagrams.
