...
git clone https://github.com/hyperpolymath/Exnovation.jl.git cd
Exnovation.jl
...
toolbox create Exnovation.jl-dev toolbox enter Exnovation.jl-dev #
...
Exnovation.jl/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
