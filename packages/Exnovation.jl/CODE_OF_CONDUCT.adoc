...
Exnovation.jl a harassment-free experience for everyone, regardless of
...
|*Email* |jonathan.jewell@open.ac.uk |Detailed reports, sensitive
matters
...
. The Exnovation.jl Maintainers will review the report
...
The Exnovation.jl Maintainers will follow these guidelines in
...
. *Email* jonathan.jewell@open.ac.uk with subject line "`Appeal:
[Original Report ID]`"
...
* Appeals are reviewed by a different Exnovation.jl Maintainers member
than the original
...
* Open a
https://github.com/hyperpolymath/Exnovation.jl/discussions[Discussion]
