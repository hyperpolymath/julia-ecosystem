...
Topology]]
link:TOPOLOGY.md[image:https://img.shields.io/badge/Completion-85%25-green[Completion
Status]]
...
* *Counterfactual Modeling*: Estimate treatment effects and alternative
...
Compatible with major historical datasets: - Maddison Project Database -
Penn World Table (historical extensions) - Broadberry et al. historical
national accounts - Polity IV (institutional data) - V-Dem
...
* Maddison, A. (2007). _Contours of the World Economy 1-2030 AD: Essays
in Macro-Economic History_. Oxford University Press.
