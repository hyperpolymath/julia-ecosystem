...
*Exnovation.jl* is a decision-support library for exnovation: the
strategic retirement of legacy systems. It helps organizations assess
whether to exnovate (retire), pilot, or keep existing infrastructure
using quantitative drivers, barriers, and impact models.
...
* *`+examples/02_portfolio_management.jl+`*: Portfolio prioritization
and budgeting

=== API Reference

See link:api.md[API] for complete reference documentation.
